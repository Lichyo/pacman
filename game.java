...
//---------------繪製地圖        
		...
		public void reset(){		//把關卡全部重置
			...
			blueghost_x=offsetx+blocksize*6;blueghost_y=offsety+blocksize*17;//藍鬼的位置
			...
			orangeghost_positionx=10;orangeghost_positiony=10;//橘鬼的格子
